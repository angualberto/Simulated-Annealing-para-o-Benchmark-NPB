...
483,24~s (serial): a comparação é por fase, não por benchmark — mas mostra
que a fase dominante cabe em segundos em um único nó, onde a NASA usa
milhares de núcleos MPI.
